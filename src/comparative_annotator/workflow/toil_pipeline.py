...
def build_round_summary(round_merged, decision):
    ...
    for target_block in round_merged["targets"]:
        ...
        n_fragmented_candidates = len(
            decision.get("fragmented_candidates_by_species", {}).get(target_species, [])
        )
        ...
        targets_summary[target_species] = {
            ...
            "n_fragmented_candidates": n_fragmented_candidates,
        }
                ...
                fh.write(
                    "\t".join(
                        [
                            ...
                            str(stats["n_fragmented_candidates"]),
